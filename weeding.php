  ...
  <?php require_once('apps/header.php'); ?>
        ...
        <div class="container py-5">
            ...
            <div class="row align-items-center mb-4">
                <!-- Left Image -->
                <div class="col-md-6 ">
                <img src="assets/images/weedingbackground.png" alt="Wedding Car" class="img-fluid image-margin">
                </div>
            ...
            <div class="row align-items-center mt-4">
                    ...
                    <div class="col-md-6 order-1 order-md-2">
                        <img src="assets/images/carimage.png" alt="Event Car" class="img-fluid image-margin1">
                    </div>
                </div>
