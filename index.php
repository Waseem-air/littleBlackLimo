...
<div class="modal fade mb-5 pb-5" id="multipleTripModal" tabindex="-1" aria-labelledby="multipleTripLabel"
     aria-hidden="true">
                ...
                <form class="form" id="createJob" method="post" >
                    ...
                    <div class="d-grid mb-3">
                        <button type="button" class="btn rounded-pill py-2 fw-medium" id="addSegment"
                                style="background:#fff; border: 1px solid #CCCCCC; color:#323232;">
